...
class myclassify():
    ...
    def knn(self, k=3):
        ...
        scores = model_selection.cross_val_score(knn_model, self.x, self.y, cv=self.cv_time)
    ...
    def logistic(self):
        ...
        scores = model_selection.cross_val_score(logit_model, self.x, self.y, cv=self.cv_time)
    ...
    def decision_tree(self):
        ...
        scores = model_selection.cross_val_score(dt_model, self.x, self.y, cv=self.cv_time)
    ...
    def naive_bayes(self):
        ...
        scores = model_selection.cross_val_score(nb_model, self.x, self.y, cv=self.cv_time)
    ...
    def svm(self):
        ...
        scores = model_selection.cross_val_score(model, self.x, self.y, cv=self.cv_time)
